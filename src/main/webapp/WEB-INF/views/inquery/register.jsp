      ...
      <div class="input-form col-md-12 mx-auto">
        ...
        <div class="row">
            <div class="col-3 form-group">
              ...
              <select class="custom-select d-block w-100 " id="root" name="course_code">
                <option value=""></option>
		...
		<div class="row form-group">
		    ...
		    <div class="col-8">
		  		...
		  		<textarea class="form-control" placeholder="연락수단을 입력해 주세요" name="contact_detail"></textarea>
			</div>
		</div>
		<div class="mb-3 form-group">
			<div class="col-8">
		   		<label for="floatingTextarea">상담제목</label>
		  		<textarea class="form-control" placeholder="상담제목을 입력해 주세요 ex) 00과정 00과목 문의" name="title"></textarea>
			</div>
